      ...
      body: NotificationListener<ScrollNotification>(
        ...
        child: RefreshIndicator(
          onRefresh: () async {
            ...
            context.read<HomeBannerCubit>().fetchHomeBanner();
            context.read<AllproductBloc>().add(RefreshProductEvent());
          ...
          child: CustomScrollView(
            ...
            slivers: [
              ...
              SliverPadding(
                ...
                sliver: BlocConsumer<AllproductBloc, CommonState>(
                  listener: (context, state) {
                    if (state is! CommonLoadingState && completer.isCompleted== false) {
